  ...
  return (
    <section className={styles.useCasesSection}>
      ...
      <div className={styles.useCasesGrid}>
        <Reveal delay={0}>
          <div className={styles.useCaseCard} style={accent('#ec4899')}>
            <EqBars color="#ec4899" />
        ...
        <Reveal delay={100}>
          <div className={styles.useCaseCard} style={accent('#06b6d4')}>
            <EqBars color="#06b6d4" />
        ...
        <Reveal delay={200}>
          <div className={styles.useCaseCard} style={accent('#f97316')}>
            <EqBars color="#f97316" />
        ...
        <Reveal delay={300}>
          <div className={styles.useCaseCard} style={accent('#a855f7')}>
            <EqBars color="#a855f7" />
