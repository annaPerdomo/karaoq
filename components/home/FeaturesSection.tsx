  ...
  return (
    <section id="features" className={styles.featuresSection}>
      ...
      <div className={styles.featuresGrid}>
        <Reveal delay={0}>
          <div className={styles.featureCard} style={accent('#ec4899')}>
        ...
        <Reveal delay={100}>
          <div className={styles.featureCard} style={accent('#06b6d4')}>
            <div className={styles.featureIcon}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21.5 2v6h-6" />
                <path d="M2.5 22v-6h6" />
        ...
        <Reveal delay={200}>
          <div className={styles.featureCard} style={accent('#f97316')}>
            <div className={styles.featureIcon}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Reveal delay={0}>
          <div className={styles.featureCard} style={accent('#a855f7')}>
            <div className={styles.featureIcon}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Reveal delay={100}>
          <div className={styles.featureCard} style={accent('#10b981')}>
            <div className={styles.featureIcon}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Reveal delay={200}>
          <div className={styles.featureCard} style={accent('#3b82f6')}>
            <div className={styles.featureIcon}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
