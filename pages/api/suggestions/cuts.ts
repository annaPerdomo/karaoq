...
export default async function handler(
  ...
  // A whole venue browses from one IP, and a 429 here spends the live search
  // this endpoint exists to save.
  ...
  // room's repeat taps and the limit above only meters a catalog-walker.
  res.setHeader(
    "Cache-Control",
